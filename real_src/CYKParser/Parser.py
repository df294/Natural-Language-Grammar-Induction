...
def generate_tree(node):
    ...
    """
    if node.child2 == None:
        return "[{} '{}']".format(node.symbol, node.child1)
    else:
        return "[{} {} {}]".format(node.symbol, generate_tree(node.child1), generate_tree(node.child2))
...
if __name__ == '__main__':
    ...
    if len(ARGUMENTS) > 3 or len(ARGUMENTS) == 2:
        ...
        print("Using {} {} and {} {}.".format(ARGUMENTS[1], GRAMMAR, ARGUMENTS[2], SENTENCE))
