...
"""
#GOODFILE = "../text_files/basic_tagged_simple.txt"
#BADFILE = "../text_files/B5179_simple.txt"

GOODFILE = "../text_files/pal_easy.txt"
BADFILE = "../text_files/ungram_pal_easy.txt"
...
def checkFitness(grammar, weight1, weight2, discount_factor):
    ...
    grammatical = checkFile(modGrammar, GOODFILE)
    ungrammatical = checkFile(modGrammar, BADFILE)
